...
class Windows10UserReg(_Reg):
    ...
    def csv_user_assist(self):
        super(Windows10UserReg, self)._csv_user_assist(True)

    def csv_networks_list(self):
        super(Windows10UserReg, self)._csv_networks_list(
    ...
    def json_user_assist(self):
        super(Windows10UserReg, self)._json_user_assist(True)

    def json_networks_list(self):
        super(Windows10UserReg, self)._json_networks_list(
            r'Software\Microsoft\Windows NT\CurrentVersion\NetworkList\Profiles')
