...
class Windows2016ServerFiles(_FileCatcher):
    ...
    def csv_print_infos_files(self):
        super(Windows2016ServerFiles, self)._csv_infos_fs(self._list_files())

    def json_print_infos_files(self):
        super(Windows2016ServerFiles, self)._json_infos_fs(self._list_files())
