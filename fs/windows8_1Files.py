...
class Windows8_1Files(_FS):
    ...
    def __list_named_pipes(self):
        return super(Windows8_1Files, self)._list_named_pipes()

    def _list_windows_prefetch(self):
        return super(Windows8_1Files, self)._list_windows_prefetch()

    def _chrome_history(self):
        return super(Windows8_1Files, self)._chrome_history(
            '\\Users\\*\\AppData\\Local\\Google\\Chrome\\User Data\\*\\History')

    def _firefox_history(self):
        return super(Windows8_1Files, self)._firefox_history(
            '\\Users\\*\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\*.default\\places.sqlite')

    def csv_print_list_named_pipes(self):
        super(Windows8_1Files, self)._csv_list_named_pipes(self._list_named_pipes())

    def csv_print_list_windows_prefetch(self):
        super(Windows8_1Files, self)._csv_windows_prefetch(self._list_windows_prefetch())

    def csv_skype_history(self):
        super(Windows8_1Files, self)._skype_history(['AppData\\Roaming\\Skype'])
    ...
    def csv_firefox_downloads(self):
        ...
        super(Windows8_1Files, self)._firefox_downloads(
            ['AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\*.default\\downloads.sqlite'])

    def csv_firefox_history(self):
        super(Windows8_1Files, self)._csv_firefox_history(self._firefox_history())

    def csv_chrome_history(self):
        super(Windows8_1Files, self)._csv_chrome_history(self._chrome_history())

    def csv_get_startup_files(self):
        super(Windows8_1Files, self)._csv_get_startup_files(
            self.userprofile + '\\*\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\*')

    def json_print_list_named_pipes(self):
        super(Windows8_1Files, self)._json_list_named_pipes(self._list_named_pipes())

    def json_print_list_windows_prefetch(self):
        super(Windows8_1Files, self)._json_windows_prefetch(self._list_windows_prefetch())
    ...
    def json_firefox_history(self):
        super(Windows8_1Files, self)._json_firefox_history(self._firefox_history())

    def json_chrome_history(self):
        super(Windows8_1Files, self)._json_chrome_history(self._chrome_history())

    def json_get_startup_files(self):
        super(Windows8_1Files, self)._json_get_startup_files(
            self.userprofile + '\\*\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\*')
